...
const About = () => {
  return (
    <div className="max-w-7xl mx-auto my-1 md:my-1 px-7 relative" id="about">
      <div>
        <Headline title={"About Me"} subtitle={"Ini adalah bagian article"} />
      </div>
      {/* About content */}
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 md:w-10/12">
            {skills.map((skill) => (
              <p
                key={skills.id}
                className="bg-red-300 text-light py-2 px-4 rounded"
              >
                {skill.title}
              </p>
            ))}
